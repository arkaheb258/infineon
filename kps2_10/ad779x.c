...
//				}
				...
				if (curr == 3) {
					...
					p401_an_in[(ad7794_ch%count)+offset] = 25000;
				}
/*				
...
//dodanie 3 poziomow pradow
				if (pom_R <= 40000) {
					ad7794_curr[port2*AD7794_CHANELLS+ad7794_ch] = 3;	//1mA
				} else if (pom_R >= 500000) {
					ad7794_curr[port2*AD7794_CHANELLS+ad7794_ch] = 1;	//10uA
				} else if ((pom_R >= 60000) && (pom_R <= 400000)) {
					ad7794_curr[port2*AD7794_CHANELLS+ad7794_ch] = 2;	//210uA
				} else {
					if ((pom_R < 60000) && (ad7794_curr[port2*AD7794_CHANELLS+ad7794_ch] == 3)) {
						//bez zmian
					} else if ((pom_R > 400000) && (ad7794_curr[port2*AD7794_CHANELLS+ad7794_ch] == 1)) {
						//bez zmian
					} else {
						ad7794_curr[port2*AD7794_CHANELLS+ad7794_ch] = 2;	//210uA
					}
